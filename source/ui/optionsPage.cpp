...
optionsPage::optionsPage() : Layout::Layout() {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(settings_top))
    this->titleImage = Image::New(0, 0, pu::sdl2::TextureHandle::New(pu::ui::render::LoadImage((settings_top))));
  else
    this->titleImage =
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    this->appVersionText->SetColor(COLOR(version));
  else
...
void optionsPage::askToUpdate(std::vector<std::string> updateInfo) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_others.update"_theme)) {
...
std::string optionsPage::getMenuOptionIcon(bool ourBool) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.check_on"_theme)) {
    checked = inst::config::appDir + "icons_settings.check_on"_theme;
  }
  std::string unchecked = "romfs:/images/icons/unchecked.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.check_off"_theme)) {
...
std::string optionsPage::getMenuLanguage(int ourLangCode) {
  ...
  //
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.sys"_theme)) {
    sys = inst::config::appDir + "icons_flags.sys"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.en"_theme)) {
    en = inst::config::appDir + "icons_flags.en"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.jpn"_theme)) {
    jpn = inst::config::appDir + "icons_flags.jpn"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.fr"_theme)) {
    fr = inst::config::appDir + "icons_flags.fr"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.de"_theme)) {
    de = inst::config::appDir + "icons_flags.de"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.it"_theme)) {
    it = inst::config::appDir + "icons_flags.it"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.ru"_theme)) {
    ru = inst::config::appDir + "icons_flags.ru"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.es"_theme)) {
    es = inst::config::appDir + "icons_flags.es"_theme;
  }
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_flags.tw"_theme)) {
    tw = inst::config::appDir + "icons_flags.tw"_theme;
  }
  /* temp comment out until next update
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
  std::filesystem::exists(inst::config::appDir + "icons_flags.cn"_theme)) { cn = inst::config::appDir +
  "icons_flags.cn"_theme;
  }
  */
  if (ourLangCode >= 0) {
    if (ourLangCode == 0)
...
void thememessage() {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_others.theme"_theme)) {
    theme = inst::config::appDir + "icons_others.theme"_theme;
  }
  int ourResult =
      inst::ui::mainApp->CreateShowDialog("theme.title"_lang, "theme.desc"_lang, {"common.no"_lang, "common.yes"_lang},
                                          true, pu::sdl2::TextureHandle::New(pu::ui::render::LoadImage(theme)));
  if (ourResult != 0) {
...
void optionsPage::setMenuText() {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    ignoreFirmOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    validateOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    overclockOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    deletePromptOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    autoUpdateOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    useSoundOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    useMusicOption->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    fixticket->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    listoveride->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    httpkeyboard->SetColor(COLOR(text_colour));
  else
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    useThemeOption->SetColor(COLOR(text_colour));
  else
    useThemeOption->SetColor(COLOR("#FFFFFFFF"));
  useThemeOption->SetIcon(
      pu::sdl2::TextureHandle::New(pu::ui::render::LoadImage(this->getMenuOptionIcon(inst::config::useTheme))));
  this->menu->AddItem(useThemeOption);

  auto ThemeMenuOption = pu::ui::elm::MenuItem::New("theme.theme_menu"_lang);
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    ThemeMenuOption->SetColor(COLOR(text_colour));
  else
    ThemeMenuOption->SetColor(COLOR("#FFFFFFFF"));
  std::string thememenu = "romfs:/images/icons/thememenu.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.theme_dl"_theme)) {
  ...
  auto ThemeUrlOption = pu::ui::elm::MenuItem::New("theme.theme_url"_lang +
                                                   inst::util::shortenString(inst::config::httplastUrl2, 42, false));
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    ThemeUrlOption->SetColor(COLOR(text_colour));
  else
    ThemeUrlOption->SetColor(COLOR("#FFFFFFFF"));
  std::string themeurl = "romfs:/images/icons/themeurl.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.theme_server"_theme)) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    SigPatch->SetColor(COLOR(text_colour));
  else
    SigPatch->SetColor(COLOR("#FFFFFFFF"));
  std::string sigs = "romfs:/images/icons/plaster.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.patches"_theme)) {
  ...
  auto sigPatchesUrlOption = pu::ui::elm::MenuItem::New(
      "options.menu_items.sig_url"_lang + inst::util::shortenString(inst::config::sigPatchesUrl, 42, false));
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    sigPatchesUrlOption->SetColor(COLOR(text_colour));
  else
    sigPatchesUrlOption->SetColor(COLOR("#FFFFFFFF"));
  std::string sigsurl = "romfs:/images/icons/keyboard.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.patches_server"_theme)) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    httpServerUrlOption->SetColor(COLOR(text_colour));
  else
    httpServerUrlOption->SetColor(COLOR("#FFFFFFFF"));
  std::string neturl = "romfs:/images/icons/url.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.net_source"_theme)) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    languageOption->SetColor(COLOR(text_colour));
  else
    languageOption->SetColor(COLOR("#FFFFFFFF"));
  std::string lang = "romfs:/images/icons/speak.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.language"_theme)) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    updateOption->SetColor(COLOR(text_colour));
  else
    updateOption->SetColor(COLOR("#FFFFFFFF"));
  std::string upd = "romfs:/images/icons/update2.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.update"_theme)) {
  ...
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json"))
    creditsOption->SetColor(COLOR(text_colour));
  else
    creditsOption->SetColor(COLOR("#FFFFFFFF"));
  std::string credit = "romfs:/images/icons/credits2.png";
  if (op_theme && inst::config::useTheme && std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
      std::filesystem::exists(inst::config::appDir + "icons_settings.credits"_theme)) {
      ...
      if (prev_touchcount != 1) {
        ...
        case 1:
          if (inst::config::validateNCAs) {
            ...
            if (op_theme && inst::config::useTheme &&
        ...
        case 12:
          keyboardResult =
              inst::util::softwareKeyboard("inst.net.url.hint"_lang, inst::config::httplastUrl2.c_str(), 500);
        ...
        case 14:
          keyboardResult =
              inst::util::softwareKeyboard("options.sig_hint"_lang, inst::config::sigPatchesUrl.c_str(), 500);
          if (keyboardResult.size() > 0) {
        ...
        case 18:
          if (op_theme && inst::config::useTheme &&
              std::filesystem::exists(inst::config::appDir + "/theme/theme.json") &&
              std::filesystem::exists(inst::config::appDir + "icons_others.credits"_theme)) {
            inst::ui::mainApp->CreateShowDialog("options.credits.title"_lang, "options.credits.desc"_lang,
                                                {"common.close"_lang}, true,
                                                pu::sdl2::TextureHandle::New(pu::ui::render::LoadImage(
                                                    inst::config::appDir + "icons_others.credits"_theme)));
          } else {
